...
class Game2048Grid (GG.GameGrid):
    ...
    def move_tiles_down (self):
        ...
        # inits
        t1,t2,tv=4,4,0
        if self.x.valid_move(2):
            self.x.move(2)
            t1,t2,tv = self.x.new_tile()
        _at = self.matrix.get_object_at
        ...
        self.next_tile(acted=_acted, row=t1,column=t2,tile=tv)
    ...
    def next_tile (self, tk_event=None, *args, **kw):
        ...
        if kw.get("acted"):
            ...
            self.pop_tile(row=t1,column=t2,tile=tv)
    ...
    def pop_tile (self, tk_event=None, *args, **kw):
        ...
        if not self.is_full():
            ...
            _row=kw.get("row")
            _column=kw.get("column")
            _value=kw.get("tile") *2
